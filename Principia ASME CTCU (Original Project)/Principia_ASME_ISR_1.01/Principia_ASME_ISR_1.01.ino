...
void loop() {
  ...
  Channel5Data();//Checks the state of the launcher input
...
void Channel5Data(){
Ch5Pwm = pulseIn(Ch5_pin,HIGH,2000);
//  Ch5CurrentState = digitalRead(Ch5_pin);
//  Serial.print("\n");
//  Serial.print("Current State Ch5: ");
//  Serial.print(Ch5CurrentState);
//  Serial.print("\n");
//  Serial.print("Previous State Ch5: ");
//  Serial.print(Ch5PreviousState);
//  
//  //Triggers on rising edge
//  if(Ch5CurrentState == HIGH && Ch5PreviousState == LOW){
//    Ch5PreviousState = HIGH;
//    Ch5RisingEdgeTime = micros();  
//    Serial.print("\n");
//    Serial.print("Rising Edge Ch5: ");
//    Serial.print(Ch5RisingEdgeTime);
//  }
//  //Triggers on falling edge
//  else if(Ch5CurrentState == LOW && Ch5PreviousState == HIGH){
//  Serial.print("\n");
//  Serial.print("Inside Falling Edge");
//    Ch5PreviousState = LOW;
//    Ch5FallingEdgeTime = micros();
//    Ch5TimeDif = Ch5FallingEdgeTime - Ch5RisingEdgeTime; 
//    Ch5Pwm = Ch5TimeDif;   
//  Serial.print("\n");
//  Serial.print("Falling Edge Ch5: ");
//  Serial.print(Ch5FallingEdgeTime);
//  delay(100);
//  }
